			...
			if name == 'patternList': 
				for x_inpart in x_part:
					if x_inpart.tag == 'pattern': 
						self.instrumentList.append(hydrogen_pattern(x_inpart))
...
apeinst_obj = hydrogen_song()
apeinst_obj.load_from_file("G:\\RandomMusicFiles\\toy\\hydrogen\\GM_kit_Diddley.h2song")
